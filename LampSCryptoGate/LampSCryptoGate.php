    ...
    public function install(InstallContext $context)
    {
        ...
        $options = [
            ...
            'additionalDescription' =>
                ...
                . '<div id="payment_desc">'
                . '  Jetzt sicher und verschlüsselt mit Bitcoin, Bitcoin Cash, Dash oder Litecoin zahlen.'
                . '</div>'
        ];
        ...
        $options = [
            ...
            'description' => 'Kryptowährung Bitcoin',
            'action' => 'CryptoGatePayment',
            'active' => 0,
            'position' => 0,
            'additionalDescription' =>
                ...
                . '<div id="payment_desc">'
                . '  Jetzt sicher und verschlüsselt mit Bitcoin zahlen.'
                . '</div>'
        ];
        $installer->createOrUpdate($context->getPlugin(), $options);
        ...
        $options = [
            ...
            'description' => 'Kryptowährung Litecoin',
            'action' => 'CryptoGatePayment',
            'active' => 0,
            'position' => 0,
            'additionalDescription' =>
                ...
                . '<div id="payment_desc">'
                . '  Jetzt sicher und verschlüsselt mit Litecoin zahlen.'
                . '</div>'
        ];
        $installer->createOrUpdate($context->getPlugin(), $options);
        ...
        $options = [
            ...
            'description' => 'Kryptowährung Bitcoin Cash',
            'action' => 'CryptoGatePayment',
            'active' => 0,
            'position' => 0,
            'additionalDescription' =>
                ...
                . '<div id="payment_desc">'
                . '  Jetzt sicher und verschlüsselt mit Bitcoin Cash zahlen.'
                . '</div>'
        ];
        $installer->createOrUpdate($context->getPlugin(), $options);
        ...
        $options = [
            ...
            'description' => 'Kryptowährung Dash',
            'action' => 'CryptoGatePayment',
            'active' => 0,
            'position' => 0,
            'additionalDescription' =>
                ...
                . '<div id="payment_desc">'
                . '  Jetzt sicher und verschlüsselt mit Dash zahlen.'
                . '</div>'
        ];
        $installer->createOrUpdate($context->getPlugin(), $options);
